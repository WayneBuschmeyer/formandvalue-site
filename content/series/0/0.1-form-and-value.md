...
There is what something is
There is everything it could become
Mathematics lives in that space, between what is fixed, and what is flexible
...
Later, sine is redefined analytically on the unit circle
    ...
    sin(θ) = y, where (x, y) lies on the unit circle and makes angle θ with the positive x-axis.
